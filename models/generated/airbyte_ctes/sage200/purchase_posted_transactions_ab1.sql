...
-- depends_on: {{ source('sage200_etl', '_airbyte_raw_purchase_posted_transactions') }}
select
...
from {{ source('sage200_etl', '_airbyte_raw_purchase_posted_transactions') }} as table_alias
