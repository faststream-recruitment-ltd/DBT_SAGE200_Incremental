{{ config(
    ...
    post_hook = ["
                    ...
                    {% endif %}
                    ","delete from _airbyte_sage200_etl_stg.nominal_transaction_enquiry_views_stg where _airbyte_emitted_at != (select max(_airbyte_emitted_at) from _airbyte_sage200_etl_stg.nominal_transaction_enquiry_views_stg)"],
    tags = [ "top-level" ]
) }}
